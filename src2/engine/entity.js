  ...
  update(dt) {
    ...
    switch (this.state) {
      ...
      default:
        ...
        else if (this.def.worker || this.def.weaponless) { if (!this.order && (this.world.autoMine !== false) && !this.def.mcv && !(this.team === 0 && this.world.coach && this.world.coach.active)) this.setOrder({ type: 'harvest' }); } // v2.47: MCV must not auto-harvest; v2.65: coach keeps PLAYER workers idle until the harvest lesson is taught
